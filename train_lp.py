...
def train(args):
    ...
    for runtime in range(5):
        ...
        test_acc_clean.append(best_test_metrics['roc'])
        test_score_attack.append(best_test_metrics['ap'])
    ...
    logging.info("*" * 80)
    logging.info("test_roc: ", )
    logging.info(test_acc_clean)
    logging.info("test_ap", )
    logging.info(test_score_attack)
    logging.info("Mean of test_roc: ", )
    logging.info(statistics.mean(test_acc_clean))
    logging.info("Std of test_roc: ")
    logging.info(statistics.stdev(test_acc_clean))
    logging.info("Mean of test_ap: ", )
    logging.info(statistics.mean(test_score_attack))
    logging.info("Std of test_ap: ", )
    logging.info(statistics.stdev(test_score_attack))
    print("test_roc: ", test_acc_clean)
    print("test_roc mean: ", statistics.mean(test_acc_clean))
    print("test_roc var: ", statistics.stdev(test_acc_clean))

    print("test_ap: ", test_score_attack)
    print("test_ap mean: ", statistics.mean(test_score_attack))
    print("test_ap var: ", statistics.stdev(test_score_attack))
