...
def load_data_nc(dataset, use_feats, data_path, split_seed):
    if dataset in ['cora', 'pubmed','citeseer']:
        ...
        if dataset == 'disease_nc':
            ...
            val_prop, test_prop = 0.15, 0.15
            labels = labels.numpy()
            idx_train, idx_val, idx_test = get_train_val_test_split(random_state=split_seed,labels=labels,train_examples_per_class=20,val_examples_per_class=None,test_examples_per_class=None,train_size=None, val_size=500, test_size=1000)
